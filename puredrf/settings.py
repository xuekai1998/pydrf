...
# OpenAPI / Swagger 文档设置（访问 /api/schema/ 和 /docs/）
SPECTACULAR_SETTINGS = {
    "TITLE": "Pure-DRF Admin Backend API",
    "DESCRIPTION": "OpenAPI schema for Pure-DRF backend",
    "VERSION": "1.0.0",
    # Swagger UI 默认会带入 BearerAuth（配合 JWT）
